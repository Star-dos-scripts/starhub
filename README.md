...
if game.CoreGui:FindFirstChild("SysBroker") then
	game:GetService("StarterGui"):SetCore("SendNotification", {Title = "Star Hub",Text = "Script carregado!, rejoin to re-execute",Duration = 5;})
	return
end
local version = 2
--VARIABLES
...
Background.ZIndex = 9
Background.Image = "rbxassetid://95527690181891"
